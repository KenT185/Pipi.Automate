...
public class WordTablesMerger
{
    ...
    private static void InitializeAndValidateFiles()
    {
        ...
        _destinationFilePath = Path.Combine(_sourceDirectory, "merged-file.docx");
    ...
    private void MergeDocxTables()
    {
        ...
        try
        {
            using (var targetFile = WordprocessingDocument.Create(_destinationFilePath, DocumentFormat.OpenXml.WordprocessingDocumentType.Document))
            {
